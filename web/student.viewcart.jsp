                    ...
                    <div class="row">
                        <div id="layout-page" class="col-md-12 col-sm-12 col-xs-12">
                            <span class="header-page clearfix">
                                ...
                                <c:if test="${mess != null}">
                                    <div style="padding-left: 150px; color: rgba(247,0,00.92)">${mess}</div>
                                    <% session.removeAttribute("mess"); %>
                                </c:if>
                            </span>
                            <span class="header-page clearfix">
                                <h1 style="padding-top: 10px; text-align: center;">Cart</h1>
                            </span>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <c:forEach var="ca" items="${listcart}" varStatus="loop">
                                            <tr>
                                                ...
                                                <td class="item">
                                                    <a href="#"><strong>${ca.courseid.title}</strong></a>
                                                </td>
                                                <td class="price" style="color: #e32828">${ca.courseid.price}$</td>
                                                <td class="remove">
                                                    <a href="#" class="cart" onclick="confirmDelete(${ca.cartid},${u.userid})">Delete</a>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                    <script>
                                        function confirmDelete(cartid, userid) {
                                            var result = confirm("Bạn có muốn xóa không?");
                                            if (result) {
                                                window.location.href = "deletecart?cartid=" + cartid + "&&userid=" +userid;
                                            }
                                        }
                                    </script>
                                    ...
                                    <tr class="summary">
                                        ...
                                        <td class="price">
                                            <b>Total:</b>
                                            <span class="total">
                                                <strong style="color: #e32828">${total}$</strong>
                                            </span>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
